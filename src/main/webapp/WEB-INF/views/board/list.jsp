...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">게시판 목록 [list.jsp]</h1>
	</div>
	<!-- /.col-lg-12 -->
</div>
<!-- /.row -->
...
<script type="text/javascript">
	$(document).ready(function() {
		var result = '<c:out value="${result}"/>'; <!--addFlashAttribute가 만든 result를 갖고 온 것이다.-->
	
		checkModal(result); <!--함수호출 -->
		history.replaceState({}, null,null);
		
		function checkModal(result){ <!--함수선언 -->
		...
		$("#regBtn").on("click", function(){ <!--jQuery-->
